...
import dacapoIcon from "../assets/companies/dacapoIcon.jpeg"
import mathworksIcon from "../assets/companies/mathworksIcon.jpeg";
...
const TimelineElement = ({
  ...
  <VerticalTimelineElement
    ...
    date={
      <div>
        <h3 className="text-white text-[18px] font-source font-bold">{date}</h3>
      </div>
    }
    contentArrowStyle={{
  ...
  >
    <h3 className="vertical-timeline-element-title font-source font-bold text-3xl">
      {title}
    </h3>
    <h4 className="vertical-timeline-element-subtitle italic font-paragraph">
      {subtitle}
    </h4>
          ...
          <div className="vertical-timeline-container pb-40">
            <VerticalTimeline>
              ...
              <TimelineElement
                ...
                subtitle="Mathworks & Break Through Tech AI @ MIT"
                description="Developing and implementing supervised learning models and Convolutional Neural Networks (CNNs) in Python and MATLAB to forecast future shoreline changes"
              ...
              <TimelineElement
                date="JUN 2024 - AUG 2024"
                title="Machine Learning & Computational Biology Intern"
                subtitle="DaCapo Brainscience"
                description="Visualizing molecular interaction networks for large genomic datasets using Python and Cytoscape. Building proof of concept pipelines for machine learning algorithms, including NMF Elimination and Hierarchical Clustering on genomic datasets. Enhanced data accessibility and workflow by 75% through designing and implementing a centralized database with React, PostgreSQL, Django, Docker, and Postman."
                skills="Python, Cytoscape, NMF Elimination, Hierarchical Clustering, JupyterLab, Azure, Docker, React, PostgreSQL, Django, Postman"
                icon={dacapoIcon}
              />
