...
const About = () => {
    return (
        <div name="about" className="w-full h-screen bg-gradient-to-b from-blue-960 via-deep-blue to-black text-white flex flex-col-reverse md:flex-row">
...
const Image = ({ src, alt }) => (
    <div className="relative w-[50%] max-h-[28%] mx-auto rounded">
