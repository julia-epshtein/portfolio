...
const Contact = () => {
    return (
        <div name="contact" className="w-full h-screen pb-20 bg-gradient-to-br from-violet-400 to-sky-300 text-black pt-20">
            <div className="max-w-screen-lg w-full mx-auto flex flex-col justify-center">
                ...
                <div className="flex justify-start items-center p-8">
                    <div className="bg-neutral-800 rounded-3xl p-8 w-full md:w-3/4">
                        <form action="https://getform.io/f/bnlezorb" method="POST">
                            <div className="mb-6">
                            ...
                            <button type="submit" className="text-white bg-black font-source text-2xl px-8 py-4 mx-auto rounded-xl hover:scale-110 duration-300">
                                <span>
                                    Send {" "}
